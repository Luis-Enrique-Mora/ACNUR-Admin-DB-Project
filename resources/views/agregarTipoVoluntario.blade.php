...
<meta charset="UTF-8">
    ...
    <title>Agregar Tipo Voluntario</title>
...
<body>
    ...
    <div class="container">
    <form method="POST" action="/tipoVoluntario/add">
                @csrf
                <h2>Agregar Tipo Voluntario</h2>
                <hr>
                <div class="row">

                    <div class="col">
                        <input type="text" class="form-control" name="tipo" placeholder="Tipo Voluntario" required>
                    </div>
